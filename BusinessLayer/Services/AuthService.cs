...
namespace BusinessLayer.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IUserRepository userRepository, ITokenService tokenService, IConfiguration configuration, IEmailService emailService, IStudentRepository studentRepository, ITutorRepository tutorRepository)
        {
